...
import { ML_FORMULAS } from "./mlTier2Factory.js";

// Lägg till/kommentera bort formler här för att aktivera/inaktivera dem.
export const FORMULA_RUNNERS = [
  evPct,
  evPctWithMultiplier,
  evPctLeagueAvg,
  evPctMultifactor,
  ...
  // ML-baserade formler från Tier 2-modeller
  ...ML_FORMULAS,
];
