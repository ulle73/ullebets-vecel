...
export function computeTrackedOddsWindow({
  ...
  const closingPoint = prematchHistory[prematchHistory.length - 1] || null;
  ...
  return {
    ...
    latestPrematchOdds: closingPoint?.odds ?? null,
    latestPrematchObservedAt: closingPoint?.observedAt ?? null,
