...
def _build_go_live_summary(models, tier_label="Tier 2"):
    if not models:
...
def run_and_log():
    ...
    gate_summary_path = log_dir / "tier2_go_live_summary.txt"
    ...
    if proc.returncode == 0 and entry.get("models"):
        ...
        gate_summary_text = _build_go_live_summary(entry.get("models"), tier_label="Tier 2")
