...
export default function AIInsightsList({ overRows = [], underRows = [], generatedAt, isLoading, error }) {
        ...
        {rows.map((row) => (
          ...
          >
            ...
            <p className="text-[11px] text-slate-400">
              Score: <span className="font-semibold text-emerald-300">{row.score?.toFixed?.(1) ?? row.score ?? "—"}</span>
            </p>
          </li>
        ))}
      </ol>
