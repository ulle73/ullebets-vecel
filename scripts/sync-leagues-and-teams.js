...
const JSON_PATH = path.join(__dirname, "../data/leagues-and-teams.json");
// const JSON_PATH_PUBLIC = path.join(__dirname, "frontend/public/leagues-and-teams.json");
const LEAGUE_IMG_DIR = path.join(__dirname, "../public/images/league");
const TEAM_IMG_DIR = path.join(__dirname, "../public/images/teams");
