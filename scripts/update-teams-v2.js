...
// //   // hur många ID:n vi faktiskt kommer att använda
...
// //     // rotera nycklar – avbryt rotationen tidigt om vi redan är klara
// //     for (let i = 0; i < context.rapidApiKeys.length; i++) {
// //       if (allaMatcher.length >= need) break;
// //       const key =
...
// //   if (rapidFoundAny && allaMatcher.length) {
// //     // vi samlade precis bara så många som behövdes, sortera & returnera
// //     return allaMatcher.sort((a, b) => b.ts - a.ts);
// //   }
