  ...
  shotsOnGoal: {
    ...
    thresholds: (scope, period) => {
      if (scope === "total") {
        ...
        if (period === "1ST")
          return [0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5, 7.5, 8.5, 9.5, 10.5, 11.5];
        if (period === "2ND")
          return [0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5, 7.5, 8.5, 9.5, 10.5, 11.5];
      } else {
        if (period === "ALL")
    ...
    thresholds: (scope, period) => {
      if (scope === "total") {
        if (period === "ALL")
          return [0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5, 7.5, 8.5, 9.5, 10.5];
        if (period === "1ST")
          return [0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5, 7.5, 8.5];
        if (period === "2ND")
          return [0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5, 7.5, 8.5];
      } else {
        if (period === "ALL")
          return [0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5, 7.5, 8.5, 9.5];
        if (period === "1ST") return [0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5, 7.5];
        if (period === "2ND") return [0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5, 7.5];
      }
      return [];
    },
  },
